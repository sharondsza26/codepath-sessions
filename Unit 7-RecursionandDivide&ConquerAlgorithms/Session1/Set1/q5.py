...
# Their power level is represented as a power of 4. Write a recursive function that calculates 
# the power of 4 raised to the nth power to determine their training level.
...
def power_of_four(n):
    ...
    # n -= 1
    return 4 * power_of_four(n-1) if n > 0 else 4 * (1 / power_of_four(abs(n-1)))
# Example Usage:
