...
# difference between the maximum and minimum travel ratings is exactly 1.

# Given an integer array rating, return the length of the longest harmonious travel sequence 
